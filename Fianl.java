...
public class Fianl {
    ...
    static String calc(String exp) throws IOException { //
        ...
        if (spltd.length == 3) {               // если количество введеных данных равно 3/ изменяя можно увеличить кол-во символов
            ...
            int num2 = Integer.parseInt(spltd[2]);//дает переменной значение третьего введенного числа
            if ((num1 > 10 || num1 < 1) || (num2 > 10 || num2 < 1)) {//условие если числа от 1 до 10
